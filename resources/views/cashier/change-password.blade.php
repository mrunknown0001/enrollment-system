            ...
            <div class="card card-primary">
                <div class="card-header">
                    <div class="header-block">
                        <p class="title"> Cashier Change Password </p>
                    </div>
                </div>
                <div class="card-block">
                    @include('includes.all')
                    <form id="signup-form" action="{{ route('cashier.password.change.post') }}" method="POST" role="form" autocomplete="off">
                        {{ csrf_field() }}
                ...
                <div class="card-footer"> <small>Cashier Change Password</small> </div>
            </div>
        </div>
