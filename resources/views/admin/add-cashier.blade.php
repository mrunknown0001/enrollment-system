        ...
        <div class="col-md-6">
            <div class="card card-block">
                <div class="title-block">
                    <h3 class="title"> Add Cashier </h3>
                </div>
                
                @include('includes.all')

                <form id="signup-form" action="{{ route('admin.add.cashier.post') }}" method="POST" role="form" autocomplete="off">
                	{{ csrf_field() }}
                    ...
                    <div class="form-group">
                    	<button class="btn btn-primary"><i class="fa fa-plus"></i> Add Cashier</button>
                    </div>
                </form>
            </div>
        </div>
